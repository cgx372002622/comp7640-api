...
public class MBGenerator {
    public static void main(String[] args) {
        MBGenerator.Generation("comp7640", "transaction", "user", "product", "vendor");
    }
    /**
     * 根据表名生成相应结构代码
...
//                            .enableSwagger()
                            //指定输出目录
                            .outputDir(System.getProperty("user.dir")+"/src/main/java/mbg");
                })
                .packageConfig(builder -> {
                    builder.entity("entity")//实体类包名
                            .parent("com.hkbu.comp7640")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
                            ...
                            //自定义mapper.xml文件输出目录
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,System.getProperty("user.dir")+"/src/main/resources/mbg/mapper"));
                })
